                ...
                <div class="block-fluid">
                    <form method="post">
                        <div class="row-form">
                            ...
                            <div class="span9"><input type="text" name="user_name" placeholder="<?php echo $user->user_name?>"/></div>
                            <div class="clear"></div>
                        </div>
                        <div class="row-form">
                            <div class="span3">Email:</div>
                            <div class="span9"><input type="text" name="user_email" placeholder="<?php echo $user->user_email?>"/></div>
                            <div class="clear"></div>
                        </div>
                        <div class="row-form">
