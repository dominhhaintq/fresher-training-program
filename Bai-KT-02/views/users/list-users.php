        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                ...
                <div class="block-fluid table-sorting">
                    <a href="./index.php?controller=users&&action=addUser" class="btn btn-add">Add User</a>
                    <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortable_2">
                        ...
                        <?php foreach ($users as $user):?>
                            <tr>
                                ...
                                <td><?php echo $user->user_time_created?></td>
                                <td><?php echo $user->user_time_updated?></td>
                                <td><a href="./index.php?controller=users&&action=editUser&&id=<?php echo $user->user_id?>" class="btn btn-info">Edit</a></td>
                            </tr>
                        <?php endforeach;?>
                        </tbody>
                    </table>
